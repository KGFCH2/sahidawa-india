            ...
            >
                ...
                {actionHref && actionLabel && (
                    <Link
                        ...
                        className="mt-5 inline-flex items-center justify-center gap-2 rounded-full bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-slate-800 focus:outline-hidden focus:ring-2 focus:ring-slate-800 focus:ring-offset-2"
                    >
                        {actionLabel}
                    </Link>
                )}
